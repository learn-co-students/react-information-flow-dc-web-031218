...
export default class Tier1 extends Component {
  ...
  changeState = e => {
    if (e.target.className === "tier1") {
      ...
      e.target.className === "tier3" &&
      e.target.parentElement.id === "one"
    ) {
      let newColor = getRandomColor();
      this.setState({
  ...
  render() {
    ...
    return (
      ...
      >
        <Tier2
          id="one"
          tier2Color={this.state.tier2Color}
          tier3Color={this.state.tier3ColorOne}
        />
        <Tier2
          id="two"
          tier2Color={this.state.tier2Color}
          tier3Color={this.state.tier3ColorTwo}
        />
      </div>
    );
  }
